    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimesScheduled", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimesScheduled_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulings_TimesScheduled_TimeId",
                        column: x => x.TimeId,
                        principalTable: "TimesScheduled",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesScheduled_RoomId",
                table: "TimesScheduled",
                column: "RoomId");
        }
